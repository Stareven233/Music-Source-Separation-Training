...
def parse_args_inference(dict_args: Union[Dict, None]) -> argparse.Namespace:
  ...
  parser.add_argument("--minus-one", action='store_true', help="Extract the minus-one track by removing the specified stem (--instrument). A more general version of --extract_instrumental.")
